...
<html>
    ...
    <body bgcolor="black">
        ...
        <div class="rai">
    <form action="PublicToiletComplaintMail" method="post">
        <div class="ae1">
            <h1 style="padding-top:120px;"><center>Public Toilets</center></h1>
            <hr >
            <table width="1000" height="300" style="padding-left:350px;">
                <tr>
                    ...
                    <td>
                <select name="problem">
                <option>Complain Regarding Repair Work</option>
                <option>Improper Management</option>
