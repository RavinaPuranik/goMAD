...
<html>
    ...
    <body bgcolor="black">
        ...
        <div class="rai">
    <form action="HospitalComplaintMail" method="post">
        <div class="ae1">
            <h1 style="padding-top:120px;"><center>Hospital & Dispensary</center></h1>
            <hr >
            <table width="1000" height="300" style="padding-left:350px;">
                <tr>
                    ...
                    <td>
                <select name="problem">
                <option>Doctors Not Available</option>
                <option>BioMedical Waste Disposal</option>
                <option>No Medicine</option>
