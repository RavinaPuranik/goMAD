...
<html>
    ...
    <body bgcolor="black">
        ...
        <div class="rai">
    <form action="PublicHealthComplaintMail" method="post">
        <div class="ae1">
            <h1 style="padding-top:120px;"><center>Public Health</center></h1>
            <hr >
            <table width="1000" height="300" style="padding-left:350px;">
                <tr>
                    ...
                    <td>
                <select name="problem">
                <option>Adulteration of Food</option>
                <option>Business Without License</option>
                <option>Inspection of Hotels-Restaurants</option>
                <option>Food Poisoning</option>
                <option>Sale of Stale Food</option>
                <option>Spraying Not Done Properly</option>
            </select>
                    </td>
                </tr>
                <tr>
