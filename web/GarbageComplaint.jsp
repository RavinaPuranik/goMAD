...
<html>
    ...
    <body bgcolor="black">
        ...
        <div class="rai">
    <form action="GarbageComplaintMail" method="post">
        
            <h1 style="padding-top:120px;"><center>Garbage & Cleanliness</center></h1>
            <hr >
            <table width="1000" height="300" style="padding-left:350px;">
                <tr>
                    ...
                    <td>
                <select name="problem">
                <option>Cleaning of Footpath</option>
                <option>Cleaning-scraping Not Carried Out</option>
                <option>Container-Dustbin Not Cleaned Properly</option>
                <option>Cleaning Vicinity of Dividers</option>
                <option>Lifting of Building Materials</option>
                <option>Lifting of Construction & Demolition</option>
                <option>Other</option>
            </select>
                    </td>
                </tr>
