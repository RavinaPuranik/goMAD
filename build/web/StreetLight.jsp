...
<html>
    ...
    <body bgcolor="black">
        ...
        <div class="rai">
    <form action="StreetLightMail" method="get">
        <div class="ae1">
            <h1 style="padding-top:120px;"><center>Street Lights</center></h1>
            <hr >
            <table width="1000" height="300" style="padding-left:350px;">
                <tr>
                    ...
                    <td>
                <select name="problem">
                <option>Area Street Light Not Working</option>
                <option>Electric Shock/Current Leakage on Pole</option>
                <option>Insufficient Ligtning</option>
                <option>Overhead Line Problem</option>
                <option>Removal of Unserviceable Street Light</option>
                <option>Switching ON-OFF Time Problem</option>
                <option>Other</option>
            </select>
                    </td>
                </tr>
