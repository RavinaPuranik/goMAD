...
<html>
    ...
    <body bgcolor="black">
        ...
        <div class="rai">
    <form name="myform" action="AadharComplaint" onsubmit="return validateForm()" method="post" >
        
            <h1 style="padding-top:120px;"><center>Aadhar Card/PAN Card/Voter ID/Driving License/Passport</center></h1>
            <hr >
            <table width="1000" height="300" style="padding-left:350px;">
                ...
                <tr>
                    <td>Card No./License No.</td>
                    <td><input type="text" name="cardno" required/></td>
                <tr>
                    <tr>
                    <td>Place of Issue</td>
                    <td><input type="text" name="poi" required/></td>
                </tr>
                    <tr>
                    <td>Name</td>
...
<option value="West Bengal">West Bengal</option>
                ...
                <tr>
                    <td>Location(where card was lost/stolen)</td>
