...
<html>
    ...
    <body bgcolor="black">
        ...
        <div class="rai">
    <form action="EWasteComplaintMail" method="post">
        <div class="ae1">
            ...
            <table width="1000" height="300" style="padding-left:350px;">
                <tr>
                    ...
                    <td>
                <select name="problem">
                <option>Consumer Electrical & Electronics(TV,AC etc)</option>
                <option>Information Technology Equipments(Computer,Printer etc)</option>
                <option>Telecommunication Equipments(Telephone,Fax etc)</option>
