...
<html>
    ...
    <body bgcolor="black">
        ...
        <div class="rai">
    <form action="WaterComplaintMail" method="post">
        <div class="ae1">
            <h1 style="padding-top:120px;"><center>Water Supply</center></h1>
            <hr >
            <table width="1000" height="300" style="padding-left:350px;">
                <tr>
                    ...
                    <td>
                <select name="problem">
                <option>Contaminated Water(impure)</option>
                <option>Illegal Connection</option>
                <option>Insufficient Supply Duration</option>
                <option>Leakage of Public Stand Post</option>
                <option>Pipeline Leakage/Valve Leakage</option>
                <option>Repairing of Hand Pump</option>
                <option>Other</option>
            </select>
                    </td>
                </tr>
