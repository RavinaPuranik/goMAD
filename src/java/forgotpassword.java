...
public class forgotpassword extends HttpServlet {
    ...
    String to=email; 
            ...
            java.sql.PreparedStatement ps=con.prepareStatement("select password from userdata where email=?");
           ...
           rs=(ResultSet) ps.executeQuery();
            rs.next();
                ...
                String s=rs.getString(1);
                 String message="The password for ur account is with emailid   "+email+"  is  "+s;
