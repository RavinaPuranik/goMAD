 ...
 * @author ADMIN
 */
public class GarbageComplaintMail extends HttpServlet {
...
String sub="Complaint regarding Garbage Collection";
...
MimeMessage msg=new MimeMessage(session);
            try {
                ...
                Logger.getLogger(GarbageComplaintMail.class.getName()).log(Level.SEVERE, null, ex);
            }
