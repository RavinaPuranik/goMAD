...
public class deleteevents extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           ps=(PreparedStatement) con.prepareStatement("delete from events where eventname=?");
           ps1=(PreparedStatement) con.prepareStatement("delete from participant where eventname=?");
