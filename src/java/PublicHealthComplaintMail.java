 ...
 * @author ADMIN
 */
public class PublicHealthComplaintMail extends HttpServlet {
...
String sub="Complaint regarding PublicHealth Problems";
...
MimeMessage msg=new MimeMessage(session);
            try {
                ...
                Logger.getLogger(PublicHealthComplaintMail.class.getName()).log(Level.SEVERE, null, ex);
            }
