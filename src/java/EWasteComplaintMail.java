 ...
 * @author ADMIN
 */
public class EWasteComplaintMail extends HttpServlet {
...
String sub="Complaint regarding EWaste Disposal";
...
MimeMessage msg=new MimeMessage(session);
            try {
                ...
                Logger.getLogger(EWasteComplaintMail.class.getName()).log(Level.SEVERE, null, ex);
            }
