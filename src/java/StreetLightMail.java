 ...
 * @author ADMIN
 */
public class StreetLightMail extends HttpServlet {
...
String sub="Complaint regarding streetlight";
...
MimeMessage msg=new MimeMessage(session);
            try {
                ...
                Logger.getLogger(StreetLightMail.class.getName()).log(Level.SEVERE, null, ex);
            }
