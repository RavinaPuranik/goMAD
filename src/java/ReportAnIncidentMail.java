 ...
 * @author ADMIN
 */
public class ReportAnIncidentMail extends HttpServlet {
...
String sub="Report An Incident";
String desc=request.getParameter("desc");
String states=request.getParameter("states");
String category=request.getParameter("category");
String city=request.getParameter("city");

String message="Incident:"+" "+desc+"\n"+"Category:"+" "+category+"\n"+"State:"+" "+states+"\n"+"City:"+" "+city+"\n";
...
MimeMessage msg=new MimeMessage(session);
            try {
                ...
                Logger.getLogger(ReportAnIncidentMail.class.getName()).log(Level.SEVERE, null, ex);
            }
