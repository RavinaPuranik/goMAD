 ...
 * @author ADMIN
 */
public class HospitalComplaintMail extends HttpServlet {
...
String sub="Complaint regarding Hospital Management";
...
MimeMessage msg=new MimeMessage(session);
            try {
                ...
                Logger.getLogger(HospitalComplaintMail.class.getName()).log(Level.SEVERE, null, ex);
            }
