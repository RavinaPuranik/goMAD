 ...
 * @author ADMIN
 */
public class MobileComplaintMail extends HttpServlet {
...
MimeMessage msg=new MimeMessage(session);
            try {
                ...
                Logger.getLogger(MobileComplaintMail.class.getName()).log(Level.SEVERE, null, ex);
            }
